...
> 現在、Live2Dの[拡張性アプリケーション](https://www.live2d.com/sdk/license/expandable/)に関する出版許諾を申請中です。
> 進捗は [Issue #4](https://github.com/takoyakisoft/VTuberKitForYMM4/issues/4) を参照してください。
> このリポジトリで公開しているのは、自作コードおよび自作アセットのみです。Live2D Cubism SDK 本体やその関連ファイルは含めていません。
...
> [!WARNING]
> 現在、Live2Dのライセンス（拡張性アプリケーション）に関する確認中です。

ご自身でLive2D公式からSDKをダウンロードし、ソースコードからビルドしていただく必要があります。
...
5. ビルド時に `CubismSdkForNative\Framework\src\Rendering\D3D11\Shaders\CubismEffect.fx` を YMM4 のプラグインフォルダ内 `Shaders` にコピーします。
